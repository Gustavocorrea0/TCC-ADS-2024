...
public class TelaDeConsultaFornecedor extends javax.swing.JFrame {

    public TelaDeConsultaFornecedor() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextFieldEstadoFornecedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(477, 313, 63, 29));
        ...
        getContentPane().add(jTextFieldNomeFantasia, new org.netbeans.lib.awtextra.AbsoluteConstraints(16, 313, 323, 29));
        ...
        getContentPane().add(jTextFieldCNPJ, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 404, 318, 29));
        ...
        getContentPane().add(jTextFieldEmailFornecedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(22, 596, 366, 29));
        ...
        getContentPane().add(jTextFieldEnderecoFornecedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(477, 500, 407, 29));
        ...
        getContentPane().add(jTextFieldRazaoSocial, new org.netbeans.lib.awtextra.AbsoluteConstraints(16, 223, 323, 29));
        ...
        jLabelIMGTelaInicialFornecedor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/telasFornecedor/img_tela_verifica_fornecedor.png"))); // NOI18N
    ...
    private void jButtonBuscarFornecedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarFornecedorActionPerformed
        try {
            ...
            Logger.getLogger(TelaDeConsultaFornecedor.class.getName()).log(Level.SEVERE, null, ex);
        }
